...
```bash
docker run -d --name mlflow -p 5000:5000 localhost/mlflow:3.1.4-py3.11
```

```bash
docker run -d --name mlflow -p 5000:5000 docker.io/clemens33/mlflow:3.1.4-py3.11
```
...
docker.io/clemens33/mlflow:3.1.4-deployments-server-py3.11 deployments-server
```
