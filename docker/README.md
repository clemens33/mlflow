...
```bash
docker run -d --name mlflow -p 5000:5000 localhost/mlflow:2.12.2-py3.11
```

```bash
docker run -d --name mlflow -p 5000:5000 docker.io/clemens33/mlflow:2.12.2-py3.11
```
...
localhost/mlflow:2.12.2-py3.11
```
...
docker.io/clemens33/mlflow:2.12.2-deployments-server-py3.11 deployments-server
```
